...
var app = (function () {
    ...
    /* src/Music.svelte generated by Svelte v3.42.6 */
    ...
    const initAudio = async () => {
    	...
    	synth = new Tone$1.PolySynth(4, Tone$1.Synth, { oscillator: { type: 'triangle' } }).toMaster();
    	synth.connect(destinationStream);
    	synth.set('detune', -1200);
    	await Tone$1.start();
    	await Tone$1.context.resume();
    ...
    const startRecording = async downloadLink => {
    	...
    	recorder.ondataavailable = async e => {
    		...
    		Tone$1.context.decodeAudioData(arrayBuffer, buffer => {
    ...
    /* src/Cell.svelte generated by Svelte v3.42.6 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			div = element("div");
    			attr_dev(div, "class", "svelte-eszcqg");
    			toggle_class(div, "active", /*active*/ ctx[0]);
    			add_location(div, file$3, 48, 1, 700);
    			attr_dev(td, "class", "svelte-eszcqg");
    			add_location(td, file$3, 47, 0, 694);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div, "mouseover", /*drawActive*/ ctx[1], true, false, false),
    					listen_dev(div, "click", /*toggleActive*/ ctx[2], false, false, false)
    				];
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['active', 'column', 'paused'];
    	...
    	return [active, drawActive, toggleActive, column, paused];
    }

    class Cell extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { active: 0, column: 3, paused: 4 });
    ...
    /* src/Row.svelte generated by Svelte v3.42.6 */
    ...
    function create_each_block$2(ctx) {
    	...
    	function cell_active_binding(value) {
    		/*cell_active_binding*/ ctx[4](value, /*cell*/ ctx[5], /*each_value*/ ctx[6], /*index*/ ctx[7]);
    	}
    	...
    	if (/*cell*/ ctx[5] !== void 0) {
    		cell_props.active = /*cell*/ ctx[5];
    	}

    	cell = new Cell({ props: cell_props, $$inline: true });
    	binding_callbacks.push(() => bind(cell, 'active', cell_active_binding));
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const cell_changes = {};
    			if (dirty & /*paused*/ 4) cell_changes.paused = /*paused*/ ctx[2];

    			if (!updating_active && dirty & /*row*/ 1) {
    				updating_active = true;
    				cell_changes.active = /*cell*/ ctx[5];
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(i, "click", /*playThisRow*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*paused, row*/ 5) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const playThisRow = () => {
    		$$invalidate(0, row.isPlaying = true, row);
    		playRow(row);

    		setTimeout(
    			() => {
    				$$invalidate(0, row.isPlaying = false, row);
    			},
    			500
    		);
    	};

    	const writable_props = ['row', 'playing', 'paused'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Row> was created with unknown prop '${key}'`);
    	});

    	function cell_active_binding(value, cell, each_value, index) {
    	...
    	return [row, playing, paused, playThisRow, cell_active_binding];
    }

    class Row extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { row: 0, playing: 1, paused: 2 });
    ...
    // (116:4) {#each scale_keys as scale}
    function create_each_block$1(ctx) {
    	let option;
    	let t0_value = /*scale*/ ctx[21] + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			option.__value = /*scale*/ ctx[21];
    			option.value = option.__value;
    			add_location(option, file$1, 116, 4, 2095);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(116:4) {#each scale_keys as scale}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$1, 128, 4, 2366);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$1, 126, 4, 2309);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(126:3) {#if config.playing}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*config*/ ctx[0].playing) return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			a4 = element("a");
    			i3 = element("i");
    			add_location(br, file$1, 111, 2, 1948);
    			attr_dev(select, "class", "svelte-vnu4ae");
    			if (/*config*/ ctx[0].scale_key === void 0) add_render_callback(() => /*select_change_handler*/ ctx[7].call(select));
    			add_location(select, file$1, 114, 3, 1978);
    			add_location(label, file$1, 112, 2, 1956);
    			attr_dev(div0, "class", "settings svelte-vnu4ae");
    			add_location(div0, file$1, 110, 1, 1923);
    			attr_dev(a0, "class", "svelte-vnu4ae");
    			add_location(a0, file$1, 124, 2, 2238);
    			attr_dev(i0, "class", "fa fa-inverse fa-lg fa-stop svelte-vnu4ae");
    			add_location(i0, file$1, 131, 39, 2462);
    			attr_dev(a1, "class", "svelte-vnu4ae");
    			add_location(a1, file$1, 131, 2, 2425);
    			attr_dev(i1, "class", "fa fa-lg fa-trash svelte-vnu4ae");
    			add_location(i1, file$1, 132, 40, 2547);
    			attr_dev(a2, "class", "svelte-vnu4ae");
    			add_location(a2, file$1, 132, 2, 2509);
    			attr_dev(i2, "class", "fa fa-lg fa-share-alt svelte-vnu4ae");
    			add_location(i2, file$1, 133, 89, 2671);
    			attr_dev(a3, "class", "share svelte-vnu4ae");
    			add_location(a3, file$1, 133, 2, 2584);
    			attr_dev(i3, "class", "fa fa-lg fa-download svelte-vnu4ae");
    			add_location(i3, file$1, 134, 43, 2753);
    			attr_dev(a4, "class", "svelte-vnu4ae");
    			add_location(a4, file$1, 134, 2, 2712);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*primaryClass*/ ctx[3]) + " svelte-vnu4ae"));
    			add_location(div1, file$1, 123, 1, 2190);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$1, 109, 0, 1898);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(a2, "click", /*click_handler_2*/ ctx[11], false, false, false),
    					listen_dev(a3, "click", /*click_handler_3*/ ctx[12], false, false, false),
    					listen_dev(a4, "click", /*click_handler_4*/ ctx[13], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const showSticky = ignored => {
    		if (headerOffset) {
    			if (window.pageYOffset > headerOffset) {
    				$$invalidate(3, primaryClass = "primary sticky");
    			} else {
    				$$invalidate(3, primaryClass = "primary");
    			}
    		}
    	};
    	...
    	const click_handler_3 = () => alert('Link copied to clipboard. Paste it to share');
    	const click_handler_4 = () => dispatch('download');
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('primaryClass' in $$props) $$invalidate(3, primaryClass = $$props.primaryClass);
    	};
    ...
    class Controls extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { grid: 5, config: 0 });
    		...
    		if (/*grid*/ ctx[5] === undefined && !('grid' in props)) {
    			console.warn("<Controls> was created without expected prop 'grid'");
    		}

    		if (/*config*/ ctx[0] === undefined && !('config' in props)) {
    			console.warn("<Controls> was created without expected prop 'config'");
    		}
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 177, 2, 3531);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	function row_row_binding(value) {
    		/*row_row_binding*/ ctx[16](value, /*row*/ ctx[25], /*each_value*/ ctx[26], /*row_index*/ ctx[27]);
    	}

    	function row_playing_binding(value) {
    		/*row_playing_binding*/ ctx[17](value, /*row*/ ctx[25]);
    	}

    	let row_props = { paused: !/*config*/ ctx[0].playing };

    	if (/*row*/ ctx[25] !== void 0) {
    		row_props.row = /*row*/ ctx[25];
    	}

    	if (/*row*/ ctx[25].isPlaying !== void 0) {
    		row_props.playing = /*row*/ ctx[25].isPlaying;
    	}

    	row = new Row({ props: row_props, $$inline: true });
    	binding_callbacks.push(() => bind(row, 'row', row_row_binding));
    	binding_callbacks.push(() => bind(row, 'playing', row_playing_binding));
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const row_changes = {};
    			if (dirty & /*config*/ 1) row_changes.paused = !/*config*/ ctx[0].playing;

    			if (!updating_row && dirty & /*grid*/ 2) {
    				updating_row = true;
    				row_changes.row = /*row*/ ctx[25];
    				add_flush_callback(() => updating_row = false);
    			}

    			if (!updating_playing && dirty & /*grid*/ 2) {
    				updating_playing = true;
    				row_changes.playing = /*row*/ ctx[25].isPlaying;
    				add_flush_callback(() => updating_playing = false);
    			}
    ...
    function create_fragment(ctx) {
    	...
    	function controls_grid_binding(value) {
    		/*controls_grid_binding*/ ctx[10](value);
    	}

    	function controls_config_binding(value) {
    		/*controls_config_binding*/ ctx[11](value);
    	}

    	let controls_props = {};

    	if (/*grid*/ ctx[1] !== void 0) {
    		controls_props.grid = /*grid*/ ctx[1];
    	}

    	if (/*config*/ ctx[0] !== void 0) {
    		controls_props.config = /*config*/ ctx[0];
    	}

    	controls = new Controls({ props: controls_props, $$inline: true });
    	binding_callbacks.push(() => bind(controls, 'grid', controls_grid_binding));
    	binding_callbacks.push(() => bind(controls, 'config', controls_config_binding));
    	controls.$on("playpause", /*togglePlaying*/ ctx[4]);
    	controls.$on("stop", /*stopPlaying*/ ctx[6]);
    	controls.$on("clear", /*clear_handler*/ ctx[12]);
    	controls.$on("rowchange", /*rowchange_handler*/ ctx[13]);
    	controls.$on("scalechange", /*scalechange_handler*/ ctx[14]);
    	controls.$on("download", /*downloadAudio*/ ctx[9]);
    	let if_block = /*recording*/ ctx[3] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Contribute your own NFT Musical sound";
    			t1 = space();
    			span = element("span");
    			t2 = text("Turn on the sound and tap on the grid to play.");
    			br0 = element("br");
    			t3 = text(" After you're done, click the download button.");
    			t4 = space();
    			br1 = element("br");
    			t5 = space();
    			...
    			t10 = space();
    			br2 = element("br");
    			add_location(h3, file, 163, 1, 3047);
    			add_location(br0, file, 164, 69, 3163);
    			attr_dev(span, "class", "tagline svelte-wvhii7");
    			add_location(span, file, 164, 1, 3095);
    			add_location(br1, file, 165, 1, 3223);
    			attr_dev(a, "download", "music-grid.wav");
    			a.hidden = "true";
    			add_location(a, file, 179, 1, 3607);
    			attr_dev(table, "class", "svelte-wvhii7");
    			add_location(table, file, 180, 1, 3689);
    			add_location(br2, file, 186, 1, 3849);
    			attr_dev(div, "class", "container svelte-wvhii7");
    			attr_dev(div, "align", "center");
    			add_location(div, file, 162, 0, 3007);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(table, "click", /*startPlaying*/ ctx[5], { once: true }, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_grid && dirty & /*grid*/ 2) {
    				updating_grid = true;
    				controls_changes.grid = /*grid*/ ctx[1];
    				add_flush_callback(() => updating_grid = false);
    			}

    			if (!updating_config && dirty & /*config*/ 1) {
    				updating_config = true;
    				controls_changes.config = /*config*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const togglePlaying = async () => {
    		$$invalidate(0, config.playing = !config.playing, config);
    	...
    	const startPlaying = async () => {
    		if (!started) {
    			$$invalidate(0, config.playing = true, config);
    			started = true;
    			await initAudio();
    		}
    	};
    	...
    	const stopPlaying = () => {
    		$$invalidate(0, config.playing = false, config);

    		if (lastRow < grid.length) {
    			$$invalidate(1, grid[lastRow].isPlaying = false, grid);
    		}

    		if (curRow < grid.length) {
    			$$invalidate(1, grid[curRow].isPlaying = false, grid);
    		}
    	...
    	const clearGrid = rows => {
    		curRow = 0;
    		$$invalidate(1, grid = [...Array(rows)].map(x => Array(columns).fill(false)));
    	};
    	...
    	const resizeGrid = rows => {
    		...
    		$$invalidate(1, grid[0].isPlaying = false, grid);
    	};
    	...
    	const initGrid = hash => {
    		...
    		if (hash.split('&').length > 1) {
    			$$invalidate(0, config.speed = parseInt(hash.split('&')[1], 10), config);
    		}

    		if (hash.split('&').length > 2) {
    			$$invalidate(0, config.scale_key = hash.split('&')[2], config);
    		}
    	};
    	...
    	const changeSpeed = bpm => {
    		...
    		gameInterval = setInterval(
    			() => {
    				if (config.playing) {
    					$$invalidate(1, grid[lastRow].isPlaying = false, grid);
    					$$invalidate(1, grid[curRow].isPlaying = true, grid);
    					playRow(grid[curRow]);
    					lastRow = curRow;
    	...
    	const clear_handler = () => clearGrid(config.rows);
    	...
    	function row_row_binding(value, row, each_value, row_index) {
    		each_value[row_index] = value;
    		$$invalidate(1, grid);
    	}

    	function row_playing_binding(value, row) {
    		if ($$self.$$.not_equal(row.isPlaying, value)) {
    			row.isPlaying = value;
    			$$invalidate(1, grid);
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('curRow' in $$props) curRow = $$props.curRow;
    		if ('lastRow' in $$props) lastRow = $$props.lastRow;
    	...
    	return [
    		...
    		resizeGrid,
    		downloadAudio,
    		controls_grid_binding,
    		controls_config_binding,
    		clear_handler,
    		rowchange_handler,
    		scalechange_handler,
    		a_binding,
