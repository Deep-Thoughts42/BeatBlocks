...
function IndividualPart(props) {
    ...
    return (
        <div>
            <Card style={{ backgroundColor: "#111111" }} className="p-3 ">
                <Card.Header as="h6" style={{ backgroundColor: "#333333" }} className="rounded mb-1">Part: {props.index + 1} | Owner: {props.owner}</Card.Header>
